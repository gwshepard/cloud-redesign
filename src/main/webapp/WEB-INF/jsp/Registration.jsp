...
<s:form method="post" action="registration">
	...
	<s:password name="registration.password" cssClass="registration_text" maxlength="16"></s:password> <br />

	<h4>* Confirm Account Password</h4>
	<s:password name="registration.confirmPassword" cssClass="registration_text" maxlength="16"></s:password> <br />
	...
	<s:submit name="method:submit" value="%{getText('registration.submit')}" ></s:submit>
